const quizDB = [
    ...
    {
        question: "Q7:With ctrl to create a new line or paragraph inside the cell Of libreoffice calc. which key is used?",
        a: "Shift",
        b: "Alt",
        c: "Tab",
        d: "Enter",
    ...
    {
        question: "Q8:What is the result of formula MAX(B1:B3)+MIN(B1:B3) is ?where B1=5,B2=2,B3=7 .",
        a: "7, 2",
        b: "7+2",
        c: "9",
        d: "5, 7",
    ...
    {
        question: "Q9:Formula =CONCATENATE (“CCC”, “ Rahul as Authors”) what is the result of the formula?",
        a: "CCC",
        b: "CCC Rahul",
    ...
    {
        question: "Q10:What is the maximum number of worksheets a libreoffice calc can have ?",
        a: "YES",
        b: "NO",
        c: "yes",
        d: "None of the above",
